<nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-400">
                        ...
                        <x-slot name="trigger">
                            @if (Laravel\Jetstream\Jetstream::managesProfilePhotos())
                                <button
                                    ...
                                    <span class="text-gray-800 hidden md:block dark:text-gray-200">
                                        {{ Auth::user()->name }}
                                    </span>
